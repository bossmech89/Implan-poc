...
console.log('==========================================================================\n');
fs.removeSync(__dirname + '/implan.po.json');

function generatePageObject() {
	fs.readFile(__dirname + '/implan.po.xml', function (err, data) {
		parser.parseString(data, function (err, result) {
			...
			fs.writeFile(__dirname + '/implan.po.json', JSON.stringify(pobj, null, 2), function () {
